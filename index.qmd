...
-   Deliverable D5.4 for the *Open Music Europe* consortium\
...
**Citation note:** If you refer to this Green Paper in correspondence, publications, or blog posts, please cite the latest **versioned DOI** available on Zenodo and, if applicable, include the date of access when referring to material on our GitHub repository.[^index-2]
:::
...
[^index-2]: Always use the latest versioned DOI when citing this Green Paper, available via Zenodo. If you rely on supporting material hosted in the GitHub repository, please add the date of access in your reference.
