...
Our first encounter with AI governance in music came during the *Listen Local* feasibility study (2020). By experimenting with the Spotify API, we found that Slovak listeners were rarely recommended Slovak music. This was not Spotify’s fault. In fact, Spotify’s open API and conceptual documentation gave us more insight than any competing platform (Deezer and Apple never even replied to our requests).
...
::: callout-caution
This is a pre-releasing editing reminder and placeholder for comments
...
-   ::: callout-note
    #### Pre-release reminder and editing space {.unnumbered}
...
## Policy Proposals: Aligning AI with Governance and Value Creation
