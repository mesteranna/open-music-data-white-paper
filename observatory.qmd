...
The _Open Data Directive_ grants a right of reuse for public-sector information and requires that certain “high-value datasets” be made freely available across Europe [@open_data_directive_2019_2014]. This includes cultural heritage institutions such as libraries, museums, and archives. However, the Directive stops short of providing the means to ensure that such data is actually usable.
...
This gap is directly relevant to the music ecosystem. Simply publishing datasets under the Open Data Directive does not make them fit for royalty distribution, cultural statistics, or AI-driven discovery.
