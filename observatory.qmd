...
Studies consistently show that open data remains more of a promise than a reality. Early analyses underlined that *“the economic potential of open data is significant, but realising this potential depends on overcoming barriers to data availability, quality and usability”* [@carrara_creating_2015, p.7]. Later modelling confirmed the vast estimated value of open data, but stressed that *“in practice, the impact of open data depends heavily on the extent to which it is discoverable, accessible, and usable”* [@huyer_economic_2020, p.14].  
