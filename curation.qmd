...
[![Adoptation of the value chain model of the European music ecosystem in the CEEMID report](png/ecosystem/Music_value_chain.png){fig-align="center"}](https://doi.org/10.6084/m9.figshare.19174310.v1)

Market-comparator methods show how this fragmentation translates into measurable distortions: per-hour royalty equivalents differ radically between licensing regimes, and zero-price uses (radio, YouTube, ad-supported streaming) further obscure comparability. Rights are harmonised in law, but fragmented in practice by national licensing, opaque deductions, and reporting asymmetries [@antal_mce_2021]. These hidden inequalities are not an accident: they stem directly from the structural misalignment between economic flows and data flows.
...
- **For policymakers**: providing reliable data to support cultural policy and measure the music economy.  
